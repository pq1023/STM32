...
extern const ext_game_state_t 					*get_game_state_t(void);
extern const ext_game_result_t 					*get_game_result_t(void);
extern const ext_game_robot_survivors_t 				*get_game_robot_survivors_t(void);
...
extern const ext_game_robot_state_t 			*get_game_robot_state_t(void);
extern const ext_power_heat_data_t 				*get_power_heat_data_t(void);
extern const ext_buff_musk_t 						*get_buff_musk_t(void);
...
extern const ext_game_robot_pos_t *get_Robot_Pos_t(void);//机器人位置数据
extern const ext_robot_command_t *get_Robot_Command_t(void);	
#endif
