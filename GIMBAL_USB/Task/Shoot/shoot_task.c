...
int kin = 0;
int min = 0;
uint16_t tigger_right_speed = 3000, friction_speed = 6800, tigger_left_speed = 3000;
...
//		shoot_ctrl_limit(shoot_auto);
	...
	{
		shoot_auto->trigger_right_set_speed = 0;
		shoot_auto->trigger_left_set_speed = 0;
//		shoot_auto->trigger_left_current = 0;
//		shoot_auto->trigger_right_current = 0;	
		...
		shoot_auto->trigger_left_current = PID_Calc(&shoot_auto->trigger_motor_left_pid, shoot_auto->trigger_motor_left_measure->speed_rpm, shoot_auto->trigger_left_set_speed);
		shoot_auto->trigger_right_current = PID_Calc(&shoot_auto->trigger_motor_right_pid, shoot_auto->trigger_motor_right_measure->speed_rpm, shoot_auto->trigger_right_set_speed);
		min = 2;
	}		
}
