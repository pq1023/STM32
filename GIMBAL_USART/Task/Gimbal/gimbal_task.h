...
//归中设置
#define Glimbal_Yaw_Offset  							4711
#define Glimbal_Pitch_Offset 							5409
#define 	PITCH_MIN  			-10							//抬头
#define 	PITCH_MAX   		 18							//低头
...
#define YAW_PID_MAX_OUT 										30000.0f
...
//自动巡航模式云台速度
#define GIMBAL_AUTO_PITCH_DEL             0.05
#define GIMBAL_AUTO_YAW_DEL               0.07
...
typedef struct
{
	...
	send_Tx2_t           *gimbal_send2pc;//发送给视觉的数据	
